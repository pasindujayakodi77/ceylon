...
void main() async {
  ...
  // Initialize Firebase App Check. Use debug providers during development so
  // emulator/debug builds send a valid App Check token. In production,
  // use Play Integrity / DeviceCheck or reCAPTCHA and register your apps
  ...
  try {
    ...
    // Non-fatal: App Check may not be available in some CI/dev setups.
