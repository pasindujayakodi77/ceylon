...
class PromotedBusinessesCarousel extends StatefulWidget {
  ...
  @override
  State<PromotedBusinessesCarousel> createState() => _PromotedBusinessesCarouselState();
}

class _PromotedBusinessesCarouselState extends State<PromotedBusinessesCarousel> {
  ...
  Widget build(BuildContext context) {
    ...
    final query = FirebaseFirestore.instance
        ...
        .where('promotedUntil', isGreaterThan: Timestamp.now()) // Only active promotions
                  ...
                  FilledButton.icon(
                    onPressed: () async {
                      ...
                      if (business.phone != null && business.phone!.isNotEmpty) {
                        final whatsappUrl = 'https://wa.me/${business.phone!.replaceAll(RegExp(r'[^\d+]'), '')}';
                        try {
