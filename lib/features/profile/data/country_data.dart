/// Country class representing country name and code
class Country {
  final String name;
  final String code;
...
/// Static list of countries to avoid rebuilding the list on each widget build
...
/// Optimized search function to filter countries
